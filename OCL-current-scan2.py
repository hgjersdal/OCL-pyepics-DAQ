...
# with h5py.File('/var/data/ocl/2017-11-14-OCL-currentscan-100nA.h5', 'w') as h5f: #set to w- to ensure no overwriting
...
# with h5py.File('/var/data/ocl/2017-11-14-OCL-currentscan-300nA.h5', 'w-') as h5f: #set to w- to ensure no overwriting
#     for sample, pos in samples.iteritems():
#         group = grabData.makePathname(sample) #Store in group names after sample
#         print('Sample ' + group)
#         moveStage.move_to(samples['FC'])
...
with h5py.File('/var/data/ocl/2017-11-14-OCL-currentscan-600nA.h5', 'w-') as h5f: #set to w- to ensure no overwriting
    for sample, pos in samples.iteritems():
        group = grabData.makePathname(sample) #Store in group names after sample
        print('Sample ' + group)
        moveStage.move_to(samples['FC'])
